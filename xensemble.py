...
class EnsembleExplainer:
    def __init__(self, X_train_preprocessed: pd.DataFrame | np.ndarray, categorical_features_names: list[str],
        ...
        self.original_fic = FeatureBasedExplainers(self.clf, self.X_train, self.predict_proba_function)
        self.noisy_fic = None
    ...
    def init(self):
        ...
        self.noisy_fic = FeatureBasedExplainers(self.clf, self.X_train_noisy, self.predict_proba_function)
